      ...
      e(".vlt-animated-block").each(function () {
        ...
        VLTJS.window.on("vlt.change-slide", function () {
          t.removeClass("animated"),
            t.parents(".vlt-section").hasClass("active") &&
              t.addClass("animated");
        });
      });
    },
      ...
      init: function () {
        function t() {
          s.find(".pp-section.active").scrollTop() > 0
            ? e(".vlt-navbar").addClass("vlt-navbar--solid")
            : e(".vlt-navbar").removeClass("vlt-navbar--solid");
        }
        function n() {
        ...
        function o() {
          ...
          0 == t
            ...
            : l.html(VLTJS.addLedingZero(t + 1));
        }
      ...
      init: function () {
        ...
        void 0 !== e.fn.superclick &&
          ...
          r.on("click", function (e) {
            e.preventDefault(),
              t || VLTJS.menuOffcanvas.open_menu(n, c, a, o, s);
          }),
          ...
          VLTJS.document.keyup(function (e) {
            27 === e.keyCode &&
              t &&
              (e.preventDefault(),
              VLTJS.menuOffcanvas.close_menu(n, c, a, o, s));
          }),
