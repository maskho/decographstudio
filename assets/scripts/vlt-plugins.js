...
(function ($) {
    ...
    return {
      ...
      destroy: function () {
        return this.each(function () {
          ...
          o.$path
            .removeClass(o.activeClass + " " + c.bcClass)
  ...
  $.fn.superclick = function (method, args) {
    if (methods[method]) {
      ...
      return $.error(
        "Method " + method + " does not exist on jQuery.fn.superclick"
      );
    }
  };
...
!(function (e, t) {
  ...
  function n(e) {
    var t = {
      ...
      s = Array.apply(null, n.rootElement.querySelectorAll(n.include)).filter(
        function (e) {
          return (
            (t = e),
            (r = n.exclude),
        ...
        var e =
          (function () {
            ...
            if (e) {
              ...
              return c()
                ? { type: "keyframes", name: s, vendor: t, keyframes: i }
                : n("@keyframes missing '}'");
            }
          })() ||
          (function () {
            var e = o(/^@supports *([^{]+)/);
            if (e)
              return { type: "supports", supports: e[1].trim(), rules: y() };
          })() ||
          (function () {
          ...
          (function () {
            var e = o(/^@media([^{]+)*/);
            if (e)
              return { type: "media", media: (e[1] || "").trim(), rules: y() };
          })() ||
          (function () {
          ...
          (function () {
            if (o(/^@page */))
              return { type: "page", selectors: f() || [], declarations: p() };
          })() ||
          (function () {
            var e = o(/^@([-\w]+)?document *([^{]+)/);
            if (e)
            ...
            if (r.preserveVars || !a || 0 !== a.indexOf(d)) {
              if (-1 !== c.indexOf(p + "(")) {
                ...
                i !== o.value &&
                  ((i = v(i)),
                  r.preserveVars
                    ? (e.splice(n, 0, { type: s, property: a, value: i }), n++)
                    : (o.value = i));
              }
            } else e.splice(n, 1), n--;
        }
  ...
  var y = "undefined" != typeof window,
    g =
      y && window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"),
    S = { group: 0, job: 0 },
    b = {
  ...
  function k() {
    ...
    if (y) {
                ...
                return (
                  "attributes" === r.type
                    ...
                    : "childList" === r.type &&
                      ((n = r.addedNodes),
                      (o =
                        Array.apply(null, n).some(function (e) {
                          var r =
                              1 === e.nodeType &&
      ...
      if (
        (!1 === s.watch && O && (O.disconnect(), (O = null)), !s.__benchmark)
      ) {
        if (C === s.rootElement)
        ...
        if (
          ...
          if (
            (Array.apply(
              null,
              s.rootElement.querySelectorAll('[data-cssvars="out"]')
            ).forEach(function (e) {
      ...
      if ("loading" !== document.readyState)
        if (g && s.onlyLegacy) {
          ...
          !j && (s.shadowDOM || s.rootElement.shadowRoot || s.rootElement.host)
            ? n({
                  ...
                  return (
                    (e = (
                      (e = e
                        ...
                        .replace(E.cssMediaQueries, "")).match(
                        E.cssVarDeclRules
                      ) || []
                    ).join("")) || !1
                  );
                ...
                onComplete: function (e, t, r) {
                  l(e, { store: w.dom, onWarning: c }), (j = !0), k(s);
                },
              })
            : ((C = s.rootElement),
              n({
                ...
                onSuccess: function (e, t, r) {
                  ...
                  return (
                    (e = void 0 !== n && !1 === Boolean(n) ? "" : n || e),
                    s.updateURLs &&
                      (e = (function (e, t) {
                        return (
                          (
                            e.replace(E.cssComments, "").match(E.cssUrls) || []
                          ).forEach(function (r) {
                ...
                onComplete: function (r, n) {
                  var o =
                    ...
                    d = s.updateDOM
                      ...
                      ? w.job
                      : (w.job = JSON.parse(JSON.stringify(w.dom))),
                    p = !1;
                  if (
                      ...
                      o.forEach(function (t) {
                            ...
                            if (s.updateDOM) {
                              if (
                                ...
                                (y = y || E.cssKeyframes.test(n)),
                                  u.hasAttribute("data-cssvars") ||
                                    u.setAttribute("data-cssvars", "out"),
                                  i === t.textContent.replace(/\s/g, "")
                                    ? ((r = !0),
                                      u &&
                                        u.parentNode &&
                                        (t.removeAttribute(
                        ...
                        r && t.setAttribute("data-cssvars", "skip"),
                          t.hasAttribute("data-cssvars-job") ||
                            t.setAttribute("data-cssvars-job", S.job);
                      }),
                      ...
                      for (
                        var g,
                          b = [s.rootElement].concat(
                            t(s.rootElement.querySelectorAll("*"))
                          ),
                          O = 0;
                        (g = b[O]);
                        ++O
  ...
  function M(e) {
    ...
    if (t) {
      for (
        var r = e.getElementsByTagName("*"), n = [], o = 0, s = r.length;
        o < s;
        o++
      ) {
        var a = r[o];
        "none" !== getComputedStyle(a)[t] &&
          ((a.style[t] += "__CSSVARSPONYFILL-KEYFRAMES__"), n.push(a));
      }
