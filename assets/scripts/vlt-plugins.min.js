!(function (t) {
    ...
    i = {
      init: function (n) {
        ...
        return s || !(n.browser.length > 0) || (s && this.length)
          ? (i.optionCheck.call(this, n) &&
              t("." + n.overlayClass).length <= 0 &&
              i.addOverlay.call(this, n),
            n.loading &&
              t("." + n.loadingClass).length <= 0 &&
              i.addLoading.call(this, n),
            this.each(function () {
              var s = this,
                a = t(this),
                r = t(window),
      ...
      addOverlay: function (e) {
        t(e.overlayParentElement).prepend(
          '<div class="' + e.overlayClass + '"></div>'
        );
      },
      addLoading: function (e) {
        t(e.loadingParentElement).append(
          '<div class="' + e.loadingClass + '">' + e.loadingInner + "</div>"
        );
      },
      ...
      in: function () {
        ...
        a.loading && i.removeLoading.call(n),
          h && s.removeClass(h),
          d ? i.inOverlay.call(n, c, l) : i.inDefault.call(n, c, l);
      },
      ...
      out: function (n, s) {
        ...
        (r.data(e).outClass = f),
          v ? i.outOverlay.call(a, f, m, s) : i.outDefault.call(a, f, m, s);
      },
  ...
  (t.fn.animateCallback = function (e) {
    ...
    (t.fn.animsition = function (n) {
      return i[n]
        ...
        : "object" != typeof n && n
        ? void t.error("Method " + n + " does not exist on jQuery." + e)
  ...
  (function (t, e) {
    ...
    function v(t) {
      ...
      for (i = t.length; i--; )
        (t[i] && (t[i]._gsap || (t[i]._gsap = new vi(t[i], e)))) ||
          t.splice(i, 1);
      return t;
    }
    function g(t) {
    ...
    function z(t, e, i, n) {
      ...
      var s = e._prev,
        a = e._next;
      s ? (s._next = a) : t[i] === e && (t[i] = a),
        a ? (a._prev = s) : t[n] === e && (t[n] = s),
    ...
    function F(t) {
      return (t._end = w(
        t._start + (t._tDur / Math.abs(t._ts || t._pauseTS || _e) || 0)
      ));
    }
    function B(t, e) {
      var i;
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((i = D(t.rawTime(), e)),
          (!e._dur || Ze(0, e.totalDuration(), i) - e._tTime > _e) &&
            e.render(i, !0)),
        O(t)._dp && t._initted && t._time >= t._dur && t._ts)
      ) {
    ...
    function N(t, e, i) {
      ...
      return (
        (t._dur = s),
        (t._tDur = n ? (n < 0 ? 1e12 : w(s * (n + 1) + t._rDelay * n)) : s),
        i || O(t.parent),
        t.parent && F(t),
        t
      );
    ...
    function W(t) {
      ...
      return (
        n(a)
          ? (u = p = { center: 0.5, edges: 0.5, end: 1 }[a] || 0)
          : !c && d && ((u = a[0]), (p = a[1])),
        function (t, n, s) {
          var o,
            c,
          ...
          if (!S) {
            if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, Ee])[1])) {
              for (
                b = -Ee;
                b < (b = s[x++].getBoundingClientRect().left) && x < T;
    ...
    function U(t) {
      ...
      return function (i) {
        return (
          ~~(Math.round(parseFloat(i) / t) * t * e) / e + (a(i) ? 0 : Y(i))
        );
      };
    }
    function J(t, e) {
            ...
            ? s(t)
              ...
              : function (e) {
                  for (
                    ...
                    (s = n
                      ? (s = t[h].x - o) * s + (r = t[h].y - l) * r
                      : Math.abs(t[h] - o)) < c && ((c = s), (d = h));
                  return (
                    (d = !i || c <= i ? t[d] : e),
                    n || d === e || a(e) ? d : d + Y(e)
                  );
    ...
    function Z(t) {
      for (var e, i, n, s, a = 0, r = ""; ~(e = t.indexOf("random(", a)); )
        (n = t.indexOf(")", e)),
          (s = "[" === t.charAt(e + 7)),
          (i = t.substr(e + 7, n - e - 7).match(s ? Ve : Oe)),
          (r += t.substr(a, e - a) + Q(s ? i : +i[0], +i[1], +i[2] || 1e-5)),
          (a = n + 1);
    ...
    function nt(t, e, i) {
      ...
      if (!f) {
        if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), ai[t]))
          ...
          if (((f = p = t.match(Oe)), e)) {
            if (~t.indexOf("="))
              return (f = t.match(Ie)), i && f.length < 4 && (f[3] = 1), f;
          } else
            (o = (+f[0] % 360) / 360),
              (l = f[1] / 100),
              (n =
    ...
    function at(t, e, i) {
      ...
      if (
        ...
        for (r = (s = t.replace(ri, "1").split(De)).length - 1; d < r; d++)
          o +=
            s[d] +
            (~n.indexOf(d)
              ? l.shift() || c + "0,0,0,0)"
              : (a.length ? a : l.length ? l : i).shift());
      if (!s)
                  ...
                  (function (t) {
                    for (
                      ...
                      (i = a[o]),
                        ...
                        (n = i.substr(0, e)),
                        (s[r] = isNaN(n) ? n.replace(ui, "").trim() : +n),
                        (r = i.substr(e + 1).trim());
                    return s;
                  })(e[1]),
                ]
    ...
    function lt(t, e, i, n) {
      ...
      return (
        y(t, function (t) {
          for (var e in ((di[t] = Ne[t] = a),
          (di[(s = t.toLowerCase())] = i),
          a))
            di[
    ...
    function ut(t) {
      ...
      fe < n && (ve += n - me),
        ...
        (ue.time = (ge - ve) / 1e3),
        (0 < (e = ue.time - ye) || s) &&
          (ue.frame++, (ye += e + (be <= e ? 0.004 : be - e)), (i = 1)),
        s || (ce = de(ut)),
        i &&
    ...
    function pt(t) {
      return t < Te
        ...
        ? xe * Math.pow(t - 1.5 / 2.75, 2) + 0.75
        : t < 0.9090909090909092
        ? xe * (t -= 2.25 / 2.75) * t + 0.9375
        : xe * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
    }
    function ft(t, e) {
      var i = t.parent || te;
      (this.vars = t),
    ...
    function mt(t, e, i, a, r, l) {
      ...
      if (
          ...
          (c = new Ye[t]()).init(
            ...
            c.rawVars
              ...
              : (function (t, e, i, a, r) {
                  if (
                    (s(t) && (t = Ti(t, r, e, i, a)),
                    !o(t) || (t.style && t.nodeType) || Ae(t))
                  )
                    return n(t) ? Ti(t, r, e, i, a) : t;
                  var l,
                    c = {};
        ...
        ((i._pt = d = new Fi(i._pt, r, t, 0, 1, c.render, c, 0, c.priority)),
        i !== oe)
      )
        for (h = i._ptLookup[i._targets.indexOf(r)], u = c._props.length; u--; )
          h[c._props[u]] = d;
      return c;
    }
    function vt(t, e, i) {
              ...
              for (i in e)
                for (n = a.length; n--; )
                  (s = (s = t._ptLookup[n][i]) && s.d) &&
                    (s._pt && (s = yt(s, i)),
                    s && s.modifier && s.modifier(e[i], t, a[n], i));
            })(t, i);
          };
        },
      };
    ...
    function Ot(t, e, i) {
      ...
      return (
        n[e] ||
        n.getPropertyValue(e.replace(gn, "-$1").toLowerCase()) ||
        ...
        e in pn && (e = xn),
          i.removeProperty
            ? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) ||
                (e = "-" + e),
              i.removeProperty(e.replace(gn, "-$1").toLowerCase()))
            : i.removeAttribute(e);
      }
    }
        ...
        : ((o = t.getCTM && Rt(t)),
          "%" === n && (pn[e] || ~e.indexOf("adius"))
            ...
            : ((d[h ? "width" : "height"] = 100 + (f ? c : n)),
              (a =
                ~e.indexOf("adius") || ("em" === n && t.appendChild && !u)
                  ? t
                  : t.parentNode),
              ...
              (r = a._gsap) && "%" === n && r.width && h && r.time === li.time
                ...
                : (a === t && (d.position = "static"),
                  ...
                  h &&
                    "%" === n &&
                    (((r = g(a)).time = li.time), (r.width = a[p])),
                  w(f ? (s * l) / 100 : (100 / s) * l))));
    }
    function jt(t, e, i, n) {
      var s;
    ...
    function qt(t, e, i, n) {
      ...
      if (
        ...
        (i += ""),
        "auto" == (n += "") &&
          ((t.style[e] = n), (n = Ot(t, e) || n), (t.style[e] = i)),
        rt((r = [i, n])),
        (n = r[1]),
        (l = (i = r[0]).match(De) || []),
        (n.match(De) || []).length)
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ("all" === o || !0 === o) (r.cssText = ""), (n = 1);
          ...
          for (s = (o = o.split(",")).length; -1 < --s; )
            (i = o[s]),
              pn[i] && ((n = 1), (i = "transformOrigin" === i ? Tn : xn)),
              Vt(a, i);
        n &&
          (Vt(a, xn),
          l &&
      ...
      return r.svg && t.getAttribute("transform")
        ...
        : (l !== kn ||
            ...
            ((i = t.parentNode) && t.offsetParent) ||
              ((a = 1), (n = t.nextSibling), Hi.appendChild(t)),
            (l = Wt(t)),
    ...
    function Jt(t, e, i, n, s, a) {
      ...
      i
        ? d !== kn &&
          (o = m * b - v * g) &&
          ((l = T * (-v / o) + S * (m / o) - (m * w - v * y) / o),
          (T = T * (b / o) + S * (-g / o) + (g * w - b * y) / o),
          (S = l))
        : ((T = (r = Bt(t)).x + (~x[0].indexOf("%") ? (T / 100) * r.width : T)),
          (S =
            r.y + (~(x[1] || x[0]).indexOf("%") ? (S / 100) * r.height : S))),
        n || (!1 !== n && c.smooth)
          ? ((y = T - h),
            (w = S - u),
            (c.xOffset = p + (y * m + w * g) - y),
            (c.yOffset = f + (y * v + w * b) - w))
        ...
        a &&
          (Nt(a, c, "xOrigin", h, T),
          Nt(a, c, "yOrigin", u, S),
          Nt(a, c, "xOffset", p, c.xOffset),
          Nt(a, c, "yOffset", f, c.yOffset)),
    ...
    function Zt(t, e, i) {
      ...
      (d[xn] = e),
      Ni.body.appendChild(Yi),
      (n = $n(Yi, 1)),
      pn))
        (a = h[s]) !== (r = n[s]) &&
          "perspective,force3D,transformOrigin,svgOrigin".indexOf(s) < 0 &&
          ((o = Y(a) !== (c = Y(r)) ? Ht(i, s, a, c) : parseFloat(a)),
          (l = parseFloat(r)),
          (t._pt = new Fi(t._pt, h, s, o, l - o, xt)),
          (t._pt.u = c || 0),
          t._props.push(s));
    ...
    var te,
      ...
      li =
        ...
        (ue = {
          ...
          sleep: function () {
            (he ? ee.cancelAnimationFrame : clearTimeout)(ce),
              (le = 0),
              (de = m);
          },
      ...
      gi =
        ...
        (mi.totalTime = function (t, e) {
          ...
          return (
            (this._tTime !== t ||
              (!this._dur && !e) ||
              (this._initted && Math.abs(this._zTime) === _e)) &&
        ...
        (mi.time = function (t, e) {
          return arguments.length
            ? this.totalTime(
                Math.min(this.totalDuration(), t + I(this)) % this._dur ||
                  (t ? this._dur : 0),
                e
              )
            : this._time;
        ...
        (mi.startTime = function (t) {
          return arguments.length
            ? (this.parent &&
                this.parent._sort &&
                R(this.parent, this, t - this._delay),
              this)
            : this._start;
        }),
    ...
    var bi = (function (t) {
      ...
      return (
        ...
        (o.render = function (t, e, i) {
          ...
          if (b !== this._tTime || i || y) {
            ...
            if (
              ...
              for (s = this._first; s; ) {
                if (
                  ((a = s._next), (s._act || n >= s._start) && s._ts && c !== s)
                ) {
              ...
              for (var S = t < 0 ? t : n; s; ) {
                if (
                  ((a = s._prev), (s._act || S <= s._end) && s._ts && c !== s)
                ) {
                  if (s.parent !== this) return this.render(t, e, i);
                  if (
                    (s.render(
            ...
            if (
              ...
              !e &&
              (this.pause(),
              (c.render(m <= n ? 0 : -_e)._zTime = m <= n ? 1 : -1),
              this._ts)
            )
              return (this._start = h), F(this), this.render(t, e, i);
            this._onUpdate && !e && ni(this, "onUpdate", !0),
              ((b === v && v >= this.totalDuration()) ||
                (!b && this._ts < 0)) &&
                ((h !== this._start && Math.abs(d) === Math.abs(this._ts)) ||
                  ((!t && g) ||
                    !((t && 0 < this._ts) || (!b && this._ts < 0)) ||
                    A(this, 1),
                  e ||
                    (t < 0 && !m) ||
                    (ni(this, b === v ? "onComplete" : "onReverseComplete", !0),
          ...
          for (var s = [], a = this._first; a; )
            a._start >= n &&
              (a instanceof Ei
                ? e && s.push(a)
                : (i && s.push(a),
                  t && s.push.apply(s, a.getChildren(!0, e, i)))),
              (a = a._next);
          return s;
        }),
        ...
        (o.addPause = function (t, e, i) {
          ...
          return (
            (n.data = "isPause"), (this._hasPause = 1), R(this, n, j(this, t))
          );
        }),
        ...
        (o.getTweensOf = function (t, e) {
          for (var i, n = [], s = ei(t), a = this._first; a; )
            a instanceof Ei
              ? !x(a._targets, s) ||
                (e && !a.isActive("started" === e)) ||
                n.push(a)
              : (i = a.getTweensOf(s, e)).length && n.push.apply(n, i),
              (a = a._next);
          return n;
        }),
          ...
          var i = this,
            ...
            o = Ei.to(
              ...
              M(e, {
                ...
                duration:
                  e.duration ||
                  Math.abs(n - (s && "time" in s ? s.time : i._time)) /
                    i.timeScale() ||
                  _e,
                onStart: function () {
                  i.pause();
                  var t = e.duration || Math.abs(n - i._time) / i.timeScale();
                  o._dur !== t && N(o, t).render(o._time, !0, !0),
                    a && a.apply(o, r || []);
                },
              })
            );
        ...
        (o.currentLabel = function (t) {
          return arguments.length
            ? this.seek(t, !0)
            : this.previousLabel(this._time + _e);
        }),
        (o.shiftChildren = function (t, e, i) {
          void 0 === i && (i = 0);
          for (var n, s = this._first, a = this.labels; s; )
        ...
        (o.clear = function (t) {
          ...
          return (
            (this._time = this._tTime = 0), t && (this.labels = {}), O(this)
          );
        }),
        (o.totalDuration = function (t) {
          var e,
            ...
            l = Ee;
          if (arguments.length)
            return r._repeat < 0 ? r : r.timeScale(r.totalDuration() / t);
          if (r._dirty) {
            for (s = r.parent; o; )
              (e = o._prev),
                o._dirty && o.totalDuration(),
                l < (n = o._start) && r._sort && o._ts && !r._lock
                  ? ((r._lock = 1), (R(r, o, n - o._delay, 1)._lock = 0))
                  : (l = n),
                n < 0 &&
                  o._ts &&
                  ((a -= n),
                ...
                a < (i = F(o)) && o._ts && (a = i),
                (o = e);
            N(r, r === te && r._time > a ? r._time : Math.min(Ee, a), 1),
              (r._dirty = 0);
          }
          return r._tDur;
        }),
    ...
    var yi,
      ...
      xi = function t(e, i) {
        ...
        if (
          (!V || (L && y) || (y = "none"),
          (e._ease = fi(y, Ce.ease)),
          (e._yEase = P ? pi(fi(!0 === P ? y : P, Ce.ease)) : 0),
          P &&
            e._yoyo &&
            !e._repeat &&
          ...
          for (
            n = $(b, He),
              m = (h = D[(e._pt = 0)] ? g(D[0]).harness : 0) && b[h.prop],
              T = (O && l(T)) || (T && !O),
              s = 0;
            s < D.length;
            s++
            ...
            if (
              ...
              h &&
                ...
                ((e._pt = r =
                  new Fi(e._pt, o, u.name, 0, 1, u.render, u, 0, u.priority)),
              ...
              for (a in n)
                Ye[a] && (u = mt(a, n, e, f, o, B))
                  ? u.priority && (c = 1)
                  : (p[a] = r =
                      wi.call(e, o, a, "get", n[a], f, B, 0, b.stringFilter));
            e._op && e._op[s] && e.kill(o, e._op[s]),
              R &&
                e._pt &&
                ((yi = e), te.killTweensOf(o, p, "started"), (yi = 0)),
              e._pt && T && (qe[d.id] = 1);
          }
        ...
        function s(e, n, s, r) {
          ...
          if (
            ...
            if (
              ((n = c.vars),
              (h = c.timeline =
                new bi({ data: "nested", defaults: $ || {} })).kill(),
              (h.parent = i(c)),
              P)
            )
              ...
              if (((g = A.length), (w = _ ? W(_) : m), o(_)))
                for (b in _) ~Si.indexOf(b) && ((x = x || {})[b] = _[b]);
              for (u = 0; u < g; u++) {
                ...
                (f.stagger = 0),
                  ...
                  !_ &&
                    1 === g &&
                    f.delay &&
                    ((c._delay = C = f.delay), (c._start += C), (f.delay = 0)),
                  h.to(y, f, w(u, y, A));
              }
              S = C = 0;
            }
            ...
            if (f) {
              if (
                ...
                if (((n = m), (d = this.timeline), this._repeat)) {
                  ...
                  a !== o &&
                    (!this.vars.repeatRefresh ||
                      ...
                      this._lock ||
                      ((this._lock = i = 1),
                      (this.render(r * a, !0).invalidate()._lock = 0)));
                }
                if (!this._initted && V(this, n, i, e))
                ...
                for (
                  ...
                  s.r(c, s.d), (s = s._next);
                (d && d.render(t < 0 ? t : !n && l ? -_e : d._dur * c, e, i)) ||
              ...
              !(function (t, e, i, n) {
                ...
                if (
                  (o &&
                    t._repeat &&
                    ((l = Ze(0, t._tDur, e)),
                    Qe(l, o) !== Qe(t._tTime, o) &&
                      ((a = 1 - r),
                      t.vars.repeatRefresh && t._initted && t.invalidate())),
                  (t._initted || !V(t, e, n, i)) &&
                    (r !== a || n || t._zTime === _e || (!e && t._zTime)))
                ) {
                  for (
                    t._zTime = e || (i ? _e : 0),
                      t.ratio = r,
          ...
          (r.kill = function (t, e) {
            ...
            for (
              ...
              if (~h.indexOf(d[c]))
                ...
                r))
                  (l = s && s[o]) &&
                    (("kill" in l.d && !0 !== l.d.kill(o)) || z(this, l, "_pt"),
                    delete s[o]),
                    "all" !== a && (a[o] = 1);
    ...
    var _i = function (t, e, i) {
      ...
      Oi = function (t, e, i, n) {
        for (var s, a = this._pt; a; )
          (s = a._next), a.p === n && a.modifier(t, e, i), (a = s);
      },
      Ii = function (t) {
    ...
    var Bi = {
        ...
        e.forEach(function (t) {
          return (function (t) {
            ...
            if ((ci(), t !== n)) {
              if (Ye[e]) return;
              M(n, M($(t, a), r)),
                Je(n.prototype, Je(a, $(t, r))),
                (Ye[(n.prop = e)] = n),
                t.targetTest && (We.push(n), (He[e] = 1)),
                (e =
                  ("css" === e
                    ? "CSS"
      ...
      registerEffect: function (t) {
        ...
        (n || "").split(",").forEach(function (t) {
          return (
            t && !Ye[t] && !Ne[t] && p(e + " effect requires " + t + " plugin.")
          );
        }),
          (Xe[e] = function (t, e) {
            return i(ei(t), M(e || {}, s));
    ...
    var Vi,
      ...
      $n = function (t, e) {
        ...
        return (
          ...
          (v = Ut(t, i.svg)),
          i.svg &&
            ((M = !i.uncache && t.getAttribute("data-svg-origin")),
            Jt(t, M || R, !!M || i.originIsAbsolute, !1 !== i.smooth, v)),
          (f = i.xOrigin || 0),
          (m = i.yOrigin || 0),
          v !== kn &&
            ((x = v[0]),
            ...
            6 === v.length
              ...
              : ((I = v[6]),
                ...
                g &&
                  ((b = Math.cos(-g)),
                  (O = C * (y = Math.sin(-g)) + O * b),
                  (x = M = x * b - $ * y),
                  (T = k = T * b - L * y),
                  (S = P = S * b - z * y)),
                (l = (g = vn(T, x)) * fn),
                g &&
                  ((M = x * (b = Math.cos(g)) + T * (y = Math.sin(g))),
                  (k = E * b + _ * y),
                  (T = T * b - x * y),
                  (_ = _ * b - E * y),
                  (x = M),
            ...
            i.svg &&
              ...
              (i.forceCSS = t.setAttribute("transform", "") || !Gt(Ot(t, xn))),
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (g ||
                      ((b = t._gsap).renderTransform || $n(t),
                      (y = !1 !== e.smoothOrigin && b.smooth),
                      ((g = this._pt =
                        new Fi(
                          this._pt,
                          T,
                      ...
                      (r = Yt(r)),
                        b.svg
                          ...
                          : ((f = parseFloat(r.split(" ")[2]) || 0) !==
                              b.zOrigin && Nt(this, b, "zOrigin", b.zOrigin, f),
                            Nt(this, T, h, Ln(a), Ln(r)));
                      continue;
                    }
                    if ("svgOrigin" === h) {
                      Jt(t, r, 1, y, 0, this);
                ...
                if (
                  v ||
                  ((o || 0 === o) && (l || 0 === l) && !yn.test(r) && h in T)
                )
                  (p = (a + "").substr((l + "").length)) !==
                    (f =
                      (r + "").substr(((o = o || 0) + "").length) ||
                      (h in Se.units ? Se.units[h] : p)) &&
                    (l = Ht(t, h, a, f)),
                    (this._pt = new Fi(
                      this._pt,
                      v ? b : T,
    ...
    (Ri.utils.checkPrefix = Cn),
      (Vn = y(
        (Bn = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") +
          "," +
  ...
  (function (t) {
      ...
      var e = {
        ...
        c = function (e) {
          (e.retainPath = t.inArray(this[0], e.$path) > -1),
            ...
            this.parents("." + e.activeClass).length ||
              (e.onIdle.call(d(this)), e.$path.length && t.proxy(o, e.$path)());
        },
        d = function (t) {
        ...
        destroy: function () {
          return this.each(function () {
            ...
            (n = r.find(o.popUpSelector).parent("li")),
              ...
              o.$path
                .removeClass(o.activeClass + " " + e.bcClass)
        ...
        init: function (o) {
          return this.each(function () {
            ...
            (c.$path = n(l, c)),
              ...
              s(d, c),
              a(l),
              l.on("click.superclick", c.actionElement, c, r),
              d.not("." + e.bcClass).superclick("hide", !0),
              c.onInit.call(this);
          });
        },
      };
    ...
    (t.fn.superclick = function (i, n) {
      return e[i]
        ...
        : "object" != typeof i && i
        ? t.error("Method " + i + " does not exist on jQuery.fn.superclick")
  ...
  (function (t, e, i, n) {
    ...
    t.fn.pagepiling = function (s) {
      function a(t) {
        t.addClass("pp-table").wrapInner(
          '<div class="pp-tableCell" style="height:100%" />'
        );
      }
      function r(e) {
        return t(".pp-section.active").index(".pp-section") >
          e.index(".pp-section")
          ? "up"
          : "down";
      }
              ...
              ? ((n.translate3d = R()),
                ...
                Q.css3 ||
                  n.sectionsToMove.each(function (e) {
                    e != n.activeSection.index(".pp-section") &&
                      t(this).css(u(n.scrolling));
                  }),
                (n.animateSection = n.activeSection))
              : ((n.translate3d = "translate3d(0px, 0px, 0px)"),
                (n.scrolling = "0"),
                (n.animateSection = e)),
            t.isFunction(Q.onLeave) &&
              Q.onLeave.call(
                this,
                n.leavingSection,
                n.sectionIndex + 1,
      ...
      function c(e) {
        t.isFunction(Q.afterLoad) &&
          Q.afterLoad.call(this, e.anchorLink, e.sectionIndex + 1);
      }
      function d(e) {
      ...
      function p(t, e) {
        Q.anchors.length
          ? ((location.hash = t), f(location.hash))
          : f(String(e));
      }
      function f(e) {
        (e = e.replace("#", "")),
      ...
      function x(t, e) {
        for (
          var i = 0, n = t.slice(Math.max(t.length - e, 1)), s = 0;
          s < n.length;
          s++
        )
          i += n[s];
      ...
      function T(t, e) {
        ...
        if (
          ("down" == t
            ? ((i = "bottom"), (n = N.moveSectionDown))
            : ((i = "top"), (n = N.moveSectionUp)),
          e.length > 0)
        ) {
          if (!S(i, e)) return !0;
          n();
      ...
      function E() {
        H.get(0).addEventListener
          ? (H.get(0).removeEventListener("mousewheel", w, !1),
            H.get(0).removeEventListener("wheel", w, !1))
          : H.get(0).detachEvent("onmousewheel", w);
      }
      function _() {
        H.get(0).addEventListener
          ? (H.get(0).addEventListener("mousewheel", w, !1),
            H.get(0).addEventListener("wheel", w, !1))
          : H.get(0).attachEvent("onmousewheel", w);
      }
      function M() {
        if (q) {
          var t = P();
          H.off("touchstart " + t.down).on("touchstart " + t.down, z),
            H.off("touchmove " + t.move).on("touchmove " + t.move, A);
        }
      }
      function k() {
        if (q) {
          ...
          if ((s.length || e.preventDefault(), !v())) {
            ...
            (G = a.y),
              ...
              "horizontal" === Q.direction && Math.abs(X - W) > Math.abs(Y - G)
                ? Math.abs(X - W) > (H.width() / 100) * Q.touchSensitivity &&
                  (X > W ? T("down", s) : W > X && T("up", s))
                : Math.abs(Y - G) > (H.height() / 100) * Q.touchSensitivity &&
                  (Y > G ? T("down", s) : G > Y && T("up", s));
          }
        }
      }
      function O(e, i) {
        ...
        return (
          !!(
            i < Q.normalScrollElementTouchThreshold &&
            n.is(Q.normalScrollElements)
          ) ||
          (i != Q.normalScrollElementTouchThreshold && O(n, ++i))
        );
      }
      function I() {
        t("body").append('<div id="pp-nav"><ul></ul></div>');
        var e = t("#pp-nav");
        e.css("color", Q.navigation.textColor),
          e.addClass(Q.navigation.position);
        for (var i = 0; i < t(".pp-section").length; i++) {
          var n = "";
          if (
            (Q.anchors.length && (n = Q.anchors[i]),
            "undefined" !== Q.navigation.tooltips)
          ) {
      ...
      t.extend(t.easing, {
        ...
        (N.setAllowScrolling = function (t) {
          t
            ? (N.setMouseWheelScrolling(!0), M())
            : (N.setMouseWheelScrolling(!1), k());
        }),
        ...
        (N.moveSectionUp = function () {
          ...
          !e.length && Q.loopTop && (e = t(".pp-section").last()),
            e.length && o(e);
        }),
        (N.moveSectionDown = function () {
          var e = t(".pp-section.active").next(".pp-section");
          !e.length && Q.loopBottom && (e = t(".pp-section").first()),
            e.length && o(e);
        }),
        (N.moveTo = function (i) {
          var n = "";
      ...
      t(".pp-section")
        .each(function (e) {
          t(this).data("data-index", e),
            ...
            void 0 !== Q.anchors[e] &&
              t(this).attr("data-anchor", Q.anchors[e]),
            void 0 !== Q.sectionsColor[e] &&
              t(this).css("background-color", Q.sectionsColor[e]),
            Q.verticalCentered &&
  ...
  (function (t) {
    ...
    (e.prototype = {
      ...
      (t.fn[i] = function (n) {
        return this.each(function () {
          t.data(this, "plugin_" + i) && t.data(this, "plugin_" + i, null),
        ...
        if (
          ...
          return (
            ...
            r.required &&
              ((o = r.required),
              delete r.required,
              (r = t.extend({ required: o }, r))),
            r.remote &&
              ((o = r.remote),
              delete r.remote,
              (r = t.extend(r, { remote: o }))),
            r
          );
        }
      },
  ...
  (function (t, e) {
        ...
        if ("string" == typeof t) {
          ...
          if (r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
            ...
            for (
              s =
                e || "#" !== t[0] || t.match(/[ .<>:~]/)
                  ? (e || h).querySelectorAll(t.trim())
                  : [h.getElementById(t.trim().split("#")[1])],
                n = 0;
              n < s.length;
              n += 1
            )
      ...
      if (!this.animating || !n.preventInteractionOnTransition) {
        ...
        if (
          ("wrapper" !== n.touchEventsTarget ||
            r.closest(this.wrapperEl).length) &&
          ((e.isTouchEvent = "touchstart" === a.type),
          (e.isTouchEvent || !("which" in a) || 3 !== a.which) &&
            !(
              (!e.isTouchEvent && "button" in a && a.button > 0) ||
          ...
          if (
            ...
            if (!c || !(o <= d || o >= p.screen.width - d)) {
              if (
                ...
                var u = !0;
                r.is(e.formElements) && (u = !1),
                  h.activeElement &&
                    i(h.activeElement).is(e.formElements) &&
                    h.activeElement !== r[0] &&
      ...
      if ((r.originalEvent && (r = r.originalEvent), e.isTouched)) {
        if (!e.isTouchEvent || "touchmove" === r.type) {
          ...
          if (
            e.isTouchEvent &&
            h.activeElement &&
            r.target === h.activeElement &&
            i(r.target).is(e.formElements)
          )
            return (e.isMoved = !0), void (this.allowClick = !1);
          if (
            (e.allowTouchCallbacks && this.emit("touchMove", r),
              ...
              if (
                (void 0 === e.isScrolling &&
                  ...
                  (this.isVertical() && s.currentX === s.startX)
                    ...
                    : d * d + u * u >= 25 &&
                      ((p =
                        (180 * Math.atan2(Math.abs(u), Math.abs(d))) / Math.PI),
                ...
                if (
                    ...
                    ? ((m = !1),
                      n.resistance &&
                        (e.currentTranslate =
                          ...
                          1 +
                          Math.pow(
                            -this.minTranslate() + e.startTranslate + f,
                            g
                          )))
                    : f < 0 &&
                      ...
                      n.resistance &&
                        (e.currentTranslate =
                          ...
                          1 -
                          Math.pow(
                            this.maxTranslate() - e.startTranslate - f,
                            g
                          ))),
                  ...
                  if (!(Math.abs(f) > n.threshold || e.allowThresholdMove))
    ...
    function r(t) {
      ...
      if (
        ...
        if (n.freeMode) {
            ...
            if (i.velocities.length > 1) {
              ...
              (e.velocity = m / g),
                ...
                Math.abs(e.velocity) < n.freeModeMinimumVelocity &&
                  (e.velocity = 0),
                (g > 150 || v.now() - p.time > 300) && (e.velocity = 0);
            } else e.velocity = 0;
          ...
          for (
            var P = 0, $ = e.slidesSizesGrid[0], L = 0;
            L < o.length;
            L += L < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup
          ) {
            var z = L < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
            void 0 !== o[L + z]
              ? d >= o[L] && d < o[L + z] && ((P = L), ($ = o[L + z] - o[L]))
              : d >= o[L] && ((P = L), ($ = o[o.length - 1] - o[o.length - 2]));
          }
          var A = (d - o[P]) / $,
          ...
          if (u > n.longSwipesMs) {
            ...
            "next" === e.swipeDirection &&
              (A >= n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P)),
              "prev" === e.swipeDirection &&
                (A > 1 - n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P));
          } else {
            if (!n.shortSwipes) return void e.slideTo(e.activeIndex);
            !e.navigation ||
            (c.target !== e.navigation.nextEl &&
              c.target !== e.navigation.prevEl)
              ? ("next" === e.swipeDirection && e.slideTo(P + O),
    ...
    var m = {
        ...
        function t(t) {
          ...
          if (e) {
            ...
            if ((n.indexOf(t) < 0 && n.unshift(t), i(e).is(o))) l.apply(e, n);
              ...
              for (var s = i(e).parents(), a = 0; a < s.length; a += 1)
                i(s[a]).is(o) && l.apply(s[a], n);
          }
        }
        function e(t) {
          ...
          if (o)
            for (d = 0; d < h.length; d += 1) {
              ...
              p.dom7LiveListeners || (p.dom7LiveListeners = {}),
                ...
                p.dom7LiveListeners[f].push({ listener: l, proxyListener: t }),
            ...
            for (d = 0; d < h.length; d += 1) {
              ...
              p.dom7Listeners || (p.dom7Listeners = {}),
                ...
                p.dom7Listeners[m].push({ listener: l, proxyListener: e }),
      ...
      css: function (t, e) {
        ...
        if (1 === arguments.length) {
          ...
          if (this[0])
            return p.getComputedStyle(this[0], null).getPropertyValue(t);
        }
      ...
      parent: function (t) {
        for (var e = [], s = 0; s < this.length; s += 1)
          null !== this[s].parentNode &&
            (t
              ? i(this[s].parentNode).is(t) && e.push(this[s].parentNode)
      ...
      parents: function (t) {
        for (var e = [], s = 0; s < this.length; s += 1)
          for (var a = this[s].parentNode; a; )
            t ? i(a).is(t) && e.push(a) : e.push(a), (a = a.parentNode);
        return i(n(e));
      },
      closest: function (t) {
        var e = this;
      ...
      children: function (t) {
        for (var e = [], s = 0; s < this.length; s += 1)
          for (var a = this[s].childNodes, r = 0; r < a.length; r += 1)
            t
              ? 1 === a[r].nodeType && i(a[r]).is(t) && e.push(a[r])
              : 1 === a[r].nodeType && e.push(a[r]);
        return new f(n(e));
      },
      filter: function (t) {
        for (var e = [], i = 0; i < this.length; i += 1)
    ...
    var v = {
        ...
        extend: function () {
          ...
          for (var i = Object(t[0]), n = 1; n < t.length; n += 1) {
            ...
            if (null != s)
              for (
                var a = Object.keys(Object(s)), r = 0, o = a.length;
                r < o;
                r += 1
              ) {
                var l = a[r],
                ...
                void 0 !== c &&
                  c.enumerable &&
                  (v.isObject(i[l]) && v.isObject(s[l])
                    ? v.extend(i[l], s[l])
                    : !v.isObject(i[l]) && v.isObject(s[l])
                    ? ((i[l] = {}), v.extend(i[l], s[l]))
                    : (i[l] = s[l]));
              }
          }
          return i;
      ...
      g = {
        touch: !!(
          "ontouchstart" in p ||
          (p.DocumentTouch && h instanceof p.DocumentTouch)
        ),
        pointerEvents:
          !!p.PointerEvent &&
          "maxTouchPoints" in p.navigator &&
    ...
    (b.prototype.on = function (t, e, i) {
      ...
      (b.installModule = function (t) {
        ...
        var s =
          t.name || Object.keys(n.prototype.modules).length + "_" + v.now();
        return (
    ...
    var w,
          ...
          if (void 0 !== n) {
            ...
            for (
              var E,
                _ = e.slidesPerColumn,
                M = S / _,
                k = Math.floor(c / e.slidesPerColumn),
                P = 0;
              P < c;
              P += 1
            ) {
              ...
              if (e.slidesPerColumn > 1) {
                ...
                if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                  var O = Math.floor(
                      P / (e.slidesPerGroup * e.slidesPerColumn)
                    ),
                    ...
                    D =
                      0 === O
                        ? e.slidesPerGroup
                        : Math.min(
                            Math.ceil((c - O * _ * e.slidesPerGroup) / _),
                            e.slidesPerGroup
                          );
                  (L =
                    (z =
                      I - (A = Math.floor(I / D)) * D + O * e.slidesPerGroup) +
                    (A * S) / _),
                    $.css({
                  ...
                  "column" === e.slidesPerColumnFill
                    ? ((A = P - (z = Math.floor(P / _)) * _),
                      (z > k || (z === k && A === _ - 1)) &&
                        (A += 1) >= _ &&
                        ((A = 0), (z += 1)))
                    : (z = P - (A = Math.floor(P / M)) * M);
                $.css(
                  "margin-" + (this.isHorizontal() ? "top" : "left"),
                  0 !== A && e.spaceBetween && e.spaceBetween + "px"
                );
              }
              if ("none" !== $.css("display")) {
                if ("auto" === e.slidesPerView) {
                  ...
                  B && ($[0].style.transform = B),
                    R && ($[0].style.webkitTransform = R),
                    e.roundLengths && (C = Math.floor(C));
                } else
                  (C = (n - (e.slidesPerView - 1) * y) / e.slidesPerView),
                    e.roundLengths && (C = Math.floor(C)),
                    l[P] &&
                      (this.isHorizontal()
            ...
            if (
              ...
              for (var K = 0; K < d.length; K += 1) {
                ...
                e.roundLengths && (Z = Math.floor(Z)),
                  d[K] < this.virtualSize + d[0] && E.push(Z);
              }
              d = E;
            }
            if (!e.centeredSlides) {
              ...
              for (var tt = 0; tt < d.length; tt += 1) {
                ...
                e.roundLengths && (et = Math.floor(et)),
                  d[tt] <= this.virtualSize - n && E.push(et);
              }
              (d = E),
                Math.floor(this.virtualSize - n) - Math.floor(d[d.length - 1]) >
            ...
            if (
              ...
              0 !== e.spaceBetween &&
                (this.isHorizontal()
                  ? s
                    ? l.filter(t).css({ marginLeft: y + "px" })
                    : l.filter(t).css({ marginRight: y + "px" })
                  : l.filter(t).css({ marginBottom: y + "px" })),
            ...
            for (var r = 0; r < n.length; r += 1) {
              ...
              if (
                ...
                ((c >= 0 && c < this.size - 1) ||
                  ...
                  n.eq(r).addClass(e.slideVisibleClass));
              }
              o.progress = s ? -l : l;
            }
        ...
        loopCreate: function () {
          ...
          if (e.loopFillGroupWithBlank) {
            ...
            if (a !== e.slidesPerGroup) {
              for (var r = 0; r < a; r += 1) {
                var o = i(h.createElement("div")).addClass(
          ...
          s.each(function (e, n) {
            ...
            e < t.loopedSlides && c.push(n),
              e < s.length && e >= s.length - t.loopedSlides && l.push(n),
              a.attr("data-swiper-slide-index", e);
          });
          for (var d = 0; d < c.length; d += 1)
            n.append(i(c[d].cloneNode(!0)).addClass(e.slideDuplicateClass));
          for (var u = l.length - 1; u >= 0; u -= 1)
            n.prepend(i(l[u].cloneNode(!0)).addClass(e.slideDuplicateClass));
        },
        loopFix: function () {
        ...
        addSlide: function (t, e) {
          ...
          if (t <= 0) this.prependSlide(e);
            ...
            n.loop && this.loopCreate(),
              (n.observer && g.observer) || this.update(),
              n.loop
      ...
      H =
        ...
        E &&
          ...
          (T.osVersion = E[2]),
          (T.android = !0),
          (T.androidChrome = x.toLowerCase().indexOf("chrome") >= 0)),
        (_ || k || M) && ((T.os = "ios"), (T.ios = !0)),
        k && !M && ((T.osVersion = k[2].replace(/_/g, ".")), (T.iphone = !0)),
        _ && ((T.osVersion = _[2].replace(/_/g, ".")), (T.ipad = !0)),
        M &&
          ((T.osVersion = M[3] ? M[3].replace(/_/g, ".") : null),
          (T.ipod = !0)),
        T.ios &&
          T.osVersion &&
          x.indexOf("Version/") >= 0 &&
          "10" === T.osVersion.split(".")[0] &&
          (T.osVersion = x.toLowerCase().split("version/")[1].split(" ")[0]),
        (T.webView =
          !(
            !(k || _ || M) ||
            (!x.match(/.*AppleWebKit(?!.*Safari)/i) && !p.navigator.standalone)
          ) ||
          (p.matchMedia && p.matchMedia("(display-mode: standalone)").matches)),
        (T.webview = T.webView),
      ...
      Y = {
        ...
        events: {
          attachEvents: function () {
            ...
            (this.onTouchStart = s.bind(this)),
              ...
              t.cssMode && (this.onScroll = c.bind(this)),
              (this.onClick = l.bind(this));
            var u = !!t.nested;
            if (!g.touch && g.pointerEvents)
              i.addEventListener(e.start, this.onTouchStart, !1),
              ...
              if (g.touch) {
                ...
                i.addEventListener(e.start, this.onTouchStart, p),
                  i.addEventListener(
                    e.move,
                    this.onTouchMove,
                    g.passiveListener ? { passive: !1, capture: u } : u
                  ),
              ...
              ((t.simulateTouch && !H.ios && !H.android) ||
                (t.simulateTouch && !g.touch && H.ios)) &&
            ...
            if (!g.touch && g.pointerEvents)
              ...
              if (g.touch) {
                ...
                i.removeEventListener(e.start, this.onTouchStart, a),
                  ...
                  e.cancel &&
                    i.removeEventListener(e.cancel, this.onTouchEnd, a);
              }
              ((t.simulateTouch && !H.ios && !H.android) ||
                (t.simulateTouch && !g.touch && H.ios)) &&
        ...
        images: {
          loadImage: function (t, e, n, s, a, r) {
            ...
            var l;
            i(t).parent("picture")[0] || (t.complete && a)
              ? o()
              : e
              ? (((l = new p.Image()).onload = o),
                (l.onerror = o),
                s && (l.sizes = s),
                n && (l.srcset = n),
                e && (l.src = e))
      ...
      G = (function (t) {
        function e() {
          for (var n, s, a, r = [], o = arguments.length; o--; )
            r[o] = arguments[o];
            ...
            return (
              ...
              v.extend(l, {
                ...
                touchEvents:
                  ...
                  g.touch || !l.params.simulateTouch
                    ? l.touchEventsTouch
                    : l.touchEventsDesktop),
                touchEventsData: {
                  isTouched: void 0,
        ...
        return (
          (e.prototype.slidesPerViewDynamic = function () {
            ...
            if (t.centeredSlides) {
              for (
                var r, o = e[s].swiperSlideSize, l = s + 1;
                l < e.length;
                l += 1
              )
                e[l] &&
      ...
      et = {
        update: function (t) {
          ...
          if (
            ...
            return (
              i.slidesGrid !== f && C !== g && i.slides.css(b, C + "px"),
        ...
        renderSlide: function (t, e) {
          ...
          return (
            ...
            n.cache && (this.virtual.cache[e] = s),
            s
          );
        },
        appendSlide: function (t) {
      ...
      nt = {
        ...
        enable: function () {
          this.keyboard.enabled ||
            (i(h).on("keydown", this.keyboard.handle),
            (this.keyboard.enabled = !0));
        },
        disable: function () {
          this.keyboard.enabled &&
            (i(h).off("keydown", this.keyboard.handle),
      ...
      at = {
            ...
            : (function () {
                ...
                return (
                  !t &&
                    ...
                    (t = h.implementation.hasFeature("Events.wheel", "3.0")),
                  t
                );
              })()
            ? "wheel"
        ...
        handle: function (t) {
          ...
          if (
            ...
            !n.mouseEntered && !a[0].contains(e.target) && !s.releaseOnEdges)
          )
            return !0;
          ...
          if (
                ...
                d.each(function (t, s) {
                  ...
                  r === n && a.addClass(e.bulletActiveClass),
                    e.dynamicBullets &&
                      (r >= o &&
                        r <= l &&
                        a.addClass(e.bulletActiveClass + "-main"),
                      r === o &&
                        a
                          .prev()
            ...
            if (
              ("fraction" === e.type &&
                ...
                a.find("." + e.totalClass).text(e.formatFractionTotal(r))),
              "progressbar" === e.type)
            ) {
              var w;
            ...
            "custom" === e.type && e.renderCustom
              ? (a.html(e.renderCustom(this, n + 1, r)),
      ...
      lt = {
        ...
        enableDraggable: function () {
          if (this.params.scrollbar.el) {
            ...
            g.touch
              ? (s.addEventListener(e.start, this.scrollbar.onDragStart, a),
                s.addEventListener(e.move, this.scrollbar.onDragMove, a),
                s.addEventListener(e.end, this.scrollbar.onDragEnd, r))
        ...
        disableDraggable: function () {
          if (this.params.scrollbar.el) {
            ...
            g.touch
              ? (s.removeEventListener(e.start, this.scrollbar.onDragStart, a),
                s.removeEventListener(e.move, this.scrollbar.onDragMove, a),
                s.removeEventListener(e.end, this.scrollbar.onDragEnd, r))
              : (s.removeEventListener(i.start, this.scrollbar.onDragStart, a),
        ...
        init: function () {
          if (this.params.scrollbar.el) {
            ...
            0 === a.length &&
              ...
              s.append(a)),
              v.extend(t, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }),
        ...
        onGestureStart: function (t) {
          ...
          if (
            ...
            (n.fakeGestureTouched = !0),
              (s.scaleStart = dt.getDistanceBetweenTouches(t));
          }
        ...
        onGestureChange: function (t) {
          ...
          if (!g.gestures) {
            ...
            (i.fakeGestureMoved = !0),
              (n.scaleMove = dt.getDistanceBetweenTouches(t));
          }
          n.$imageEl &&
            0 !== n.$imageEl.length &&
            ((i.scale = g.gestures
        ...
        load: function () {
          function t(t) {
            if (l) {
              if (
                s.children(
                  "." + a.slideClass + '[data-swiper-slide-index="' + t + '"]'
                ).length
              )
                return !0;
          ...
          if (c.loadPrevNext)
            if (d > 1 || (c.loadPrevNextAmount && c.loadPrevNextAmount > 1)) {
              for (
                var u = c.loadPrevNextAmount,
                  p = d,
                  f = Math.min(o + p + Math.max(u, p), r.length),
                  m = Math.max(o - Math.max(p, u), 0),
                  v = o + d;
                v < f;
                v += 1
              )
                t(v) && n.lazy.loadInSlide(v);
          ...
          function i(t) {
            ...
            "slide" === a.params.controller.by &&
              ...
              (s && "container" !== a.params.controller.by) ||
                ...
                (s = (e - a.minTranslate()) * n + t.minTranslate())),
      ...
      ft = {
        ...
        setHistoryPopState: function () {
          (this.history.paths = ft.getPathValues()),
        ...
        scrollToSlide: function (t, e, i) {
          if (e)
            for (var n = 0, s = this.slides.length; n < s; n += 1) {
              ...
              if (
                ft.slugify(a.attr("data-history")) === e &&
        ...
        init: function () {
          if (
            ...
            this.params.hashNavigation.watchState &&
              i(p).on("hashchange", this.hashNavigation.onHashCange);
          }
        },
        destroy: function () {
          this.params.hashNavigation.watchState &&
            i(p).off("hashchange", this.hashNavigation.onHashCange);
        },
      },
      vt = {
        run: function () {
      ...
      yt = {
        setTranslate: function () {
          for (
            var t = this.slides, e = this.rtlTranslate, n = 0;
            n < t.length;
            n += 1
          ) {
            var s = t.eq(n),
        ...
        init: function () {
          ...
          t.swiper instanceof e
            ? ((this.thumbs.swiper = t.swiper),
              v.extend(this.thumbs.swiper.originalParams, {
        ...
        onThumbClick: function () {
          ...
          if (t) {
            ...
            if (
              !(
                (n &&
                  i(n).hasClass(this.params.thumbs.slideThumbActiveClass)) ||
                null == e
              )
            ) {
              var s;
      ...
      i.extend(v.prototype, {
        ...
        jumpTo: function (t, e) {
          ...
          if (!(u.isDragging || u.isClosing || (u.isAnimating && u.firstRun))) {
            ...
            if (
              ...
              (r = u.createSlide(t)),
              f > 1 &&
                ((a || r.index < f - 1) && u.createSlide(t + 1),
                (a || r.index > 0) && u.createSlide(t - 1)),
              (u.current = r),
              (u.currIndex = r.index),
              (u.currPos = r.pos),
        ...
        getFitPos: function (t) {
          ...
          return (
            ...
            "image" === t.type
              ? ((h.top =
                  Math.floor(0.5 * (n - d)) + parseFloat(l.css("paddingTop"))),
                (h.left =
                  Math.floor(0.5 * (e - c)) + parseFloat(l.css("paddingLeft"))))
              : "video" === t.contentType &&
                ((a =
                  t.opts.width && t.opts.height
                    ? c / d
                    : t.opts.ratio || 16 / 9),
                d > c / a ? (d = c / a) : c > d * a && (c = d * a)),
            (h.width = c),
            (h.height = d),
            h)
          );
        ...
        isScaledDown: function (t, e) {
          ...
          return (
            void 0 !== t && void 0 !== e
              ? (s = t < a.width && e < a.height)
              : r &&
                ((s = i.fancybox.getTranslate(r)),
                (s = s.width < a.width && s.height < a.height)),
            s
          );
        },
        canPan: function (t, e) {
          ...
          return (
            "image" === s.type &&
              ...
              void 0 !== t && void 0 !== e
                ? (a = { width: t, height: e })
                : s.isComplete && (a = i.fancybox.getTranslate(s.$content)),
              a &&
                r &&
                (r =
        ...
        loadSlide: function (t) {
          ...
          if (!t.isLoading && !t.isLoaded) {
            ...
            switch (
              ((e = t.type),
              (n = t.$slide),
              n.off("refresh").trigger("onReset").addClass(t.opts.slideClass),
              e)
            ) {
              case "image":
                a.setImage(t);
          ...
          r.isLoaded &&
            ...
            r.$content.outerHeight() > r.$slide.height() + 0.5 &&
              ...
              parseFloat(s) > 0 &&
                ...
                Math.abs(e - r.$slide[0].scrollHeight) < 1 && (i = s),
  ...
  (function (t, e, i) {
    ...
    (d.prototype.destroy = function () {
      ...
      (d.prototype.onPan = function () {
        var t = this;
        if (r(t.newPoints[0], t.realPoints[0]) < (i.fancybox.isMobile ? 10 : 5))
      ...
      (d.prototype.limitPosition = function (t, e, i, n) {
        ...
        return (
          i > a
            ? ((t = t > 0 ? 0 : t), (t = t < a - i ? a - i : t))
            : (t = Math.max(0, a / 2 - i / 2)),
          n > r
    ...
    e.extend(n.prototype, {
      ...
      e(t).on({
        "onInit.fb": function (t, e) {
          ...
          e &&
            !e.Thumbs &&
            ((i = new n(e)), i.isActive && !0 === i.opts.autoStart && i.show());
        },
        "beforeShow.fb": function (t, e, i, n) {
          var s = e && e.Thumbs;
    ...
    (t.prototype.needsClick = function (t) {
      ...
      (t.prototype.onTouchStart = function (t) {
        ...
        if (
          ...
          if (((a = window.getSelection()), a.rangeCount && !a.isCollapsed))
            return !0;
          if (!s) {
      ...
      (t.notNeeded = function (t) {
        ...
        if (
          r &&
          ((s = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/)),
          s[1] >= 10 &&
            s[2] >= 3 &&
  ...
  (function (t, e) {
    ...
    function i(t) {
      ...
      function n(t, e) {
        ...
        (t = !1 === i ? "" : i || t),
          (o[e] = t),
          -1 === o.indexOf(null) && a.onComplete(o);
      }
      var s =
    ...
    function n(t) {
      ...
      function a(t, e) {
        ...
        return (
          (n.rules = (
            t.replace(r.cssComments, "").match(r.cssImports) || []
          ).filter(function (t) {
      ...
      var r = {
        ...
        l = Array.apply(null, o.rootElement.querySelectorAll(o.include)).filter(
          function (t) {
            return (
              (e = t),
              (i = o.exclude),
    ...
    function l(e) {
          ...
          var t =
            (function () {
              ...
              if (t) {
                ...
                return a()
                  ? { type: "keyframes", name: o, vendor: e, keyframes: c }
                  : i("@keyframes missing '}'");
              }
            })() ||
            (function () {
              var t = n(/^@supports *([^{]+)/);
              if (t)
                return { type: "supports", supports: t[1].trim(), rules: m() };
            })() ||
            (function () {
            ...
            (function () {
              if (n(/^@font-face\s*/))
                return { type: "font-face", declarations: h() };
            })() ||
            (function () {
      ...
      function f() {
        ...
        return (
          a.length || i("selector missing"),
          { type: "rule", selectors: a, declarations: r }
        );
      }
      function m(t) {
        ...
        for (
          var n, r = l();
          e.length && (t || "}" !== e[0]) && (n = p() || f());

        )
          n.type && r.push(n), (r = r.concat(l()));
              ...
              if (i.preserveVars || !r || 0 !== r.indexOf(w)) {
                if (-1 !== o.indexOf(x + "(")) {
                  ...
                  l !== s.value &&
                    ((l = u(l)),
                    i.preserveVars
                      ? (t.splice(n, 0, { type: a, property: r, value: l }),
                        n++)
                      : (s.value = l));
                }
              } else t.splice(n, 1), n--;
            ...
            : n.pre.slice(0, -3) +
              (function (t) {
                var n = t.split(",")[0].replace(/[\s\n\t]/g, ""),
                  s = (t.match(/(?:\s*,\s*){1}(.*)?/) || [])[1],
                  a = Object.prototype.hasOwnProperty.call(e.variables, n)
                    ? String(e.variables[n])
                    : void 0,
                  r = a || (s ? String(s) : void 0),
                  o = i || t;
                return (
                  a || e.onWarning('variable "'.concat(n, '" is undefined')),
                  r && "undefined" !== r && r.length > 0
                    ? p(r, e, o)
                    : "var(".concat(o, ")")
                );
              })(n.body) +
    ...
    function f() {
      ...
      function s(t) {
        !o.silent && window.console && console.warn("".concat(r).concat(t)),
          o.onWarning(t);
      }
      var a =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      if (T) {
                            ...
                            (function (e) {
                              return Array.apply(null, e).some(function (e) {
                                var i = 1 === e.nodeType,
                                  n =
                                    i &&
                                    "out" === e.getAttribute("data-cssvars"),
                                  s =
                                    i &&
                                    "src" === e.getAttribute("data-cssvars"),
                                  a = s;
                                if (s || n) {
                                  var r = e.getAttribute("data-cssvars-group"),
                                    o = t.rootElement.querySelector(
                                      '[data-cssvars-group="'.concat(r, '"]')
                                    );
                                  s && (b(t.rootElement), (M.dom = {})),
        ...
        if (
          (!1 === o.watch && P && (P.disconnect(), (P = null)), !o.__benchmark)
        ) {
          if (k === o.rootElement)
          ...
          if (
            ...
            (o.variables = (function () {
              ...
              return Object.keys(t).reduce(function (i, n) {
                return (
                  (i[e.test(n) ? n : "--".concat(n.replace(/^-+/, ""))] = t[n]),
                  i
                );
              }, {});
            })(o.variables)),
            ...
            var u = o.rootElement.querySelectorAll(
        ...
        if ("loading" !== document.readyState)
          if (S && o.onlyLegacy) {
            ...
            !z &&
            (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host)
              ? n({
                  ...
                  onSuccess: function (t, e, i) {
                    return (
                      (t = (
                        (t = t
                          .replace(_.cssComments, "")
                          .replace(_.cssMediaQueries, "")).match(
                          _.cssVarDeclRules
                        ) || []
                      ).join("")) || !1
                    );
                ...
                n({
                  ...
                  onComplete: function (n, a) {
                    var r =
                      ...
                      p = o.updateDOM
                        ? M.dom
                        : Object.keys(M.job).length
                        ? M.job
                        : (M.job = JSON.parse(JSON.stringify(M.dom))),
                      v = !1;
                    if (
                      ...
                      if (
                              ...
                              if (o.updateDOM) {
                                if (
                                  ...
                                  (x = x || _.cssKeyframes.test(a)),
                                    c.hasAttribute("data-cssvars") ||
                                      c.setAttribute("data-cssvars", "out"),
                                ...
                                e.textContent.replace(/\s/g, "") !== a &&
                                  y.push(a);
                            } catch (t) {
                              i(t.message, e);
                            }
                          n && e.setAttribute("data-cssvars", "skip"),
                            e.hasAttribute("data-cssvars-job") ||
                              e.setAttribute("data-cssvars-job", C.job);
                        }),
                        ...
                        for (
                          var T,
                            S = [o.rootElement].concat(
                              e(o.rootElement.querySelectorAll("*"))
                            ),
                            E = 0;
                          (T = S[E]);
                          ++E
                          ...
                          if (
                            T.shadowRoot &&
                            T.shadowRoot.querySelector("style")
                          ) {
                            var P = t({}, o, { rootElement: T.shadowRoot });
                            f(P);
                          }
                      o.updateDOM && x && m(o.rootElement),
                        (k = !1),
                        o.onComplete(
                          y.join(""),
                          w,
    ...
    function m(t) {
      ...
      if (e) {
        for (
          var i = t.getElementsByTagName("*"), n = [], s = 0, a = i.length;
          s < a;
          s++
        ) {
          var r = i[s];
          "none" !== getComputedStyle(r)[e] &&
            ((r.style[e] += "__CSSVARSPONYFILL-KEYFRAMES__"), n.push(r));
        }
    ...
    function g() {
      return T && (window.performance || {}).now
